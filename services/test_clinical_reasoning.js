...
results.forEach((r, idx) => {
    ...
    console.log(`   Score: ${r.clinicalScore.toFixed(2)} | Coverage: ${r.coverage}/${symptoms.length} | Decisive: ${r.decisiveSymptomCount} | Char: ${r.characteristicMatchCount}`);
    if (r.patternLocked) {
...
results.slice(0, 3).forEach((r, idx) => {
    ...
    console.log(`Symptom Coverage:         ${r.coverage}/${symptoms.length} (${((r.coverage/symptoms.length)*100).toFixed(1)}%)`);
